			...
			<div class="mdl-card__supporting-text">
				<div class="mdl-grid">
					...
					<div class="mdl-cell mdl-cell--4-col">
						...
						<form action="<?php echo site_url("Issues/create"); ?>" method="post" id="form_issue" name="form_issue">
						    ...
						    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						       ...
						       <input class="mdl-textfield__input" type="text" id="issue_name" name="issue_name" value="<?php echo set_value('issue_name'); ?>">
						    </div>
