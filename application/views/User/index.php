			...
			<div class="mdl-card__title">
				...
				<div class="mdl-cell mdl-cell--8-col">
					...
					<?php endif; ?>
						...
						<a href="<?php echo site_url('user/view_admin_list'); ?>" id="view_admin"><label for="view_admin" class="mdl-button mdl-js-button mdl-button--icon"><i class="material-icons" title="View admin list">visibility</i></label></a>
					<?php endif; ?>
				</div>
			</div>
