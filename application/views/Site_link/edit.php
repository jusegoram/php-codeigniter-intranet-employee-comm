	...
	<div class="mdl-grid demo-content">
		<div class="mdl-card mdl-shadow--2dp demo-todo">
			<div class="mdl-card__title">
				<h2 class="mdl-card__title-text">Edit Site Link</h2>
			</div>
				...
				<div class="mdl-grid">
					<?php if(!empty($result)) : ?>
						...
						<div class="mdl-cell mdl-cell--4-col">
							<form action="<?php echo site_url('site_link/edit/' . $result->id ); ?>" method="post" id="form_site_link" enctype="multipart/form-data">
								...
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									...
									<textarea class="mdl-textfield__input" id="url" name="url"><?php echo $result->url; ?></textarea>
								</div>
