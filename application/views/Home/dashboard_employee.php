<main class="mdl-layout__content mdl-color--grey-100" id="content">
	<div class="square-card mdl-card mdl-shadow--2dp">
				...
				<div class="mdl-cell mdl-cell--6-col">
					<div class="mdl-card mdl-shadow--2dp">
						<div class="mdl-card__title cca-background-color cca-text-color-white">
							...
							<?php echo (!empty($user_session->hire_date)) ? '('.date('Y-m-d', $user_session->hire_date) .')':''; ?>	
							</h2>
						</div>
							...
							<div class="square-card mdl-card mdl-shadow--2dp">
								<div class="mdl-card__supporting-text">
									<table style="text-align:left; width:100%; ">
										...
										<tr><th> Hire Date </th><td><?php echo (!empty($user_session->hire_date)) ? date('Y-m-d', $user_session->hire_date):''; ?></td></tr>
									</table>
								</div>
							</div>
						</div>
		...
		<?php if(!empty($current_Performance)) : ?>
			<div class="mdl-card__supporting-text">
				<div class="mdl-grid">
					<div class="mdl-card mdl-shadow--2dp demo-todo">
						<div class="mdl-card__title cca-background-color cca-text-color-white">
							<i class="material-icons custom">equalizer</i><h2 class="mdl-card__title-text">Performance</h2>
						</div>
						...
						<div class="mdl-layout--middle">
							<div class="square-card mdl-card mdl-shadow--2dp">
								...
								<p>
									Last performance commitment
								</p>
								<div class="mdl-card--border">
									<a href="<?php echo site_url('performance/details/'. $current_Performance->id ); ?>" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect">More...</a>
								</div>
