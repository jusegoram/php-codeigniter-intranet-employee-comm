	...
	<div class="mdl-grid demo-content">
		<div class="mdl-card mdl-shadow--2dp demo-todo">
			<div class="mdl-card__title">
				<h2 class="mdl-card__title-text">Notification Details</h2>
			</div>
			<div class="mdl-card__supporting-text">
				<div class="mdl-grid">
					<?php if(!empty($result)) : ?>
						<div class="mdl-cell mdl-cell--10-col">
							<form action="<?php echo site_url('notification/details/' . $result->id);?>" method="post" class="mdl-layout" id="form_notification_details" >
							   ...
							   <?php if( !empty($result->file_name)) { ?>
								...
								<!-- <div class="mdl-cell mdl-cell--4-col"> -->
									...
									<?php $disabled_attr 	= ( ($result->is_accepted) || ($result->user_id != $user_session->id) ) ? 'disabled="disabled"' : ''; ?>
									...
									<div class="mdl-cell mdl-cell--6-col">
										<div class="mdl-layout">
											<table>
												<tr>
													<?php if( !( $result->is_accepted ) && ($result->user_id == $user_session->id) ):?>
														<td>
