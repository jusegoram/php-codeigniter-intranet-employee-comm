	...
	<div class="mdl-grid demo-content">
		<div class="mdl-card mdl-shadow--2dp demo-todo">
			<div class="mdl-card__title">
				<h2 class="mdl-card__title-text">Update Notification</h2>
			</div>
				...
				<div class="mdl-grid">
					<?php if(!empty($result)) :?>
						...
						<div class="mdl-cell mdl-cell--4-col">	
							<form action="<?php echo site_url('notification/edit/' . $result->id);?>" method="post" id="edit_form_notifications" enctype="multipart/form-data">
								...
								<div class="mdl-textfield mdl-js-textfield mdl-textfield">
								    ...
								    <select id="notification_type"  name="notification_type" class="mdl-textfield__input" <?php echo set_select('notification_type', $result->notification_type); ?> >
										...
										<option value="3" <?php echo ( 3 == $result->notification_type ) ? 'selected="selected"' : '' ?> > Training </option>
									</select>
								</div>
						    	...
						    	<?php if( !empty($result->file_name) ) { ?>
							    	<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
								       ...
								       <a class="delete_file_name" href="javascript:void(0);" data-url="<?php echo site_url('notification/delete_file');?>" data-id="<?php echo $result->id; ?>" title="Remove File"><i style="top-margin:2px;" class="material-icons" title="Remove File">cancel</i></a>
								    </div>
								<?php } ?>

						    	<?php $error_class = ( form_error('file_name') != '' )? 'has-error' : '' ?>
							    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
							       <!-- <input class="mdl-textfield__input" type="hidden" id="file_name1" name="file_name1" value="<?php //echo set_value('file_name1', $result->file_name); ?>"> -->
