	...
	<div class="mdl-grid demo-content">
		<div class="mdl-card mdl-shadow--2dp demo-todo">
			<div class="mdl-card__title">
				<div>
					<h2 class="mdl-card__title-text">Global Notification</h2>
				</div>
				<div class="mdl-cell offset 4">
					<?php if( $user_session->user_type != 2): ?>
						<a id="add_notification" href="<?php echo site_url('global_notification/create'); ?>">
							<label for="add_notification" class="mdl-button mdl-js-button mdl-button--icon">
								<i class="material-icons" title="Add Global Notification">add_box</i>
							</label>
						</a>
					<?php endif; ?>
				</div>
