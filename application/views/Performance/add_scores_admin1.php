					...
					<tbody>
						<tr>
							...
							<form action="<?php echo site_url("performance_score"); ?>" id="submit_form1" method="post" enctype="multipart/form-data">
								...
								<label class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" >Quality<input name="file_name" class="select_file" type="file" /></label>
							</form></td>
							...
							<form action="<?php echo site_url("performance_score"); ?>" id="submit_form2" class="submit_form" method="post" enctype="multipart/form-data">
								...
								<label class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" >Productivity<input name="file_name" class="select_file" type="file" /></label>
							</form></td>
							...
							<form action="<?php echo site_url("performance_score"); ?>" id="submit_form3" method="post" enctype="multipart/form-data">
								...
								<label class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" >Hours<input name="file_name" class="select_file" type="file" /></label>
							</form></td>
							...
							<form action="<?php echo site_url("performance_score"); ?>" id="submit_form4" method="post" enctype="multipart/form-data">
								...
								<label class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" >Other<input name="file_name" class="select_file" type="file" /></label>
							</form></td>
							...
							<form action="<?php echo site_url("performance_score"); ?>" id="submit_form6" method="post" enctype="multipart/form-data">
								...
								<label data-score-type="6" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" >Break Time<input name="file_name" class="select_file" type="file" /></label>
							</form></td>
						</tr>
					</tbody>
				</table>
