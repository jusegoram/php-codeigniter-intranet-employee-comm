				...
				<div class="mdl-grid">
					...
					<div class="mdl-cell mdl-cell--4-col">
						<form action="<?php echo site_url('performance/add_scores/'.$id ); ?>" method="post" id="form_score" enctype="multipart/form-data">
						    ...
						    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label get-score">
						       <label class="mdl-textfield__label" for="adherence">Hours</label>
						    ...
						    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label get-score">
						       <label class="mdl-textfield__label" for="hold_time">Productivity</label>
						    ...
						    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label get-score">
						       <label class="mdl-textfield__label" for="transfer_rate">Other</label>
